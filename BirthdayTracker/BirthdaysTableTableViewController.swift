...
class BirthdaysTableTableViewController: UITableViewController, AddBirthdayViewControllerDelegate {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int { //метод сообщает табличному представлению, сколько разделов он должен иметь
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {//настраивает каждую ячейку, которая будет отображаться в каждом ряду табличного представления
